package Dojosandninja.controllers;
...
import Dojosandninja.models.ninjas;
import Dojosandninja.models.ninjas.Ninja;
import Dojosandninja.services.DojoNinjaServ;
...
public class NinjaCont {
	...
	public String addNinja(@ModelAttribute("ninjaObject") Ninja ninja, BindingResult result) {
		if(result.hasErrors()) {
			return "/DojosAndNinjas/newninja.jsp";
		}
		else {
